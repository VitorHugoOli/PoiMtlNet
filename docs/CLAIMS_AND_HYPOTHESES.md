...
> *Relative* within-MTL recipe orderings (R2 onecycle) survive (common-mode). Source: `CONCERNS.md §C25` + `docs/studies/mtl_improvement/{log.md,HANDOFF.md,PAPER_UPDATE.md}` 2026-06-05.
