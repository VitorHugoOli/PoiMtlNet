...
- **Run dirs** (FL 5f×50ep CUDA bs=2048):
  ...
  - D8 cw=0: `_1334`
  - STL D1 alpha=0 frozen: `docs/results/P1/region_head_florida_region_5f_50ep_stl_gethard_alpha0_d1.json`
- **Predecessor docs:** `F50_T1_RESULTS_SYNTHESIS.md`, `F50_T1_5_T2_RESULTS_SYNTHESIS.md`, `F50_T1_5_CROSSATTN_ABSORPTION.md`
- **STL reference:** `docs/results/B3_baselines/stl_getnext_hard_fl_5f50ep.json` (F37 result)
