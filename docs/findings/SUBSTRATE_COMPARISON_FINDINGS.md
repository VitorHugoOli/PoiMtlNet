...
- **Per-fold JSONs**: `docs/results/phase1_perfold/{AL,AZ,FL,CA,TX}_{check2hgi,hgi}_{reg_gethard_pf_5f50ep,mtl_cat_pf,mtl_reg_pf}.json`
- **Paired-test JSONs**: `docs/results/paired_tests/{<state>_reg_acc10_pf, <state>_reg_mrr_pf, <state>_mtl_cat_f1_pf, <state>_mtl_reg_acc10_pf, <state>_mtl_reg_mrr_pf}.json`
- **P1 source JSONs**: `docs/results/P1/region_head_<state>_region_5f_50ep_STL_<STATE>_<engine>_reg_gethard_pf_5f50ep.json`
