...
**Source:** `docs/results/P8_sota/mtl_crossattn_pcgrad_al_stan_5f50ep.json`. Prior GRU-head reference: `docs/results/P2/ablation_06_crossattn_al_5f50ep.json`.
...
**Source:** `docs/results/P8_sota/mtl_crossattn_pcgrad_az_stan_5f50ep.json`. Prior GRU-head reference: `docs/results/P2/az1_crossattn_fairlr_5f50ep.json`.
