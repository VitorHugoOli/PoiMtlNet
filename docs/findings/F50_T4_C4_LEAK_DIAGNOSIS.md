...
Confirmed: `docs/results/B3_baselines/stl_getnext_hard_fl_5f50ep.json` shows F37 used `transition_path=/tmp/.../region_transition_log.pt` — the SAME full-data log_T file MTL used. The 82.44 STL ceiling is similarly inflated.
