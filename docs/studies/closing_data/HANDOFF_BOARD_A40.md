...
# TX STL reg ceiling — REUSE prior 64.96 fp32; STL cat ceiling: train.py --task next --engine check2hgi_dk_ovl --state texas --seed 0 --folds 5 --cat-head next_gru --compile --tf32 (precision-free, can run pre-verdict)
```
