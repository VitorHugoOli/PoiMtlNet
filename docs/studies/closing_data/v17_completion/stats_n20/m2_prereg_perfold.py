...
Pre-registration: docs/studies/closing_data/v17_completion/STATISTICAL_PROTOCOL.md
...
(stats_n20/RESULTS.md LIMITS #2). Those four sidecars were recovered from the A40 on 2026-07-25 and
...
Run from the repo root:
  .venv/bin/python docs/studies/closing_data/v17_completion/stats_n20/m2_prereg_perfold.py
"""
import json
...
J1 = REPO / "docs/studies/closing_data/joint_best/data/j1_results.json"
...
IST_CEIL = REPO / "docs/studies/closing_data/v17_completion/h3_istanbul/step3_runs/cat_ceiling_perfold"
