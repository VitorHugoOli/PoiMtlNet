...
- Result tables: `docs/studies/merge_design/MERGE_DESIGN_NOTES.md`,
  `docs/findings/DESIGN_D_HETEROGRAPH.md`, this `SUMMARY.md`
- Per-fold JSONs: `docs/results/phase1_perfold/{AL,AZ}_{check2hgi_poi2vec,check2hgi_postpool,design_a_concat,design_b,design_d,design_e,design_h}_*.json`
- Paired tests: `docs/results/paired_tests/{*_poi2vec,*_postpool,design_a,design_bh,design_d,design_e}_*.json`
- Generality data: `docs/results/paired_tests/generality_probes.json`
