...
- **The substrate axis is closed.** Do not re-open Tier 1-6 mechanisms. Read `docs/studies/archive/canonical_improvement/log.md` 2026-05-19 final entry first; falsified-history is off-limits.
...
- Predecessor study closure log: `docs/studies/archive/canonical_improvement/log.md` 2026-05-19 final entry
