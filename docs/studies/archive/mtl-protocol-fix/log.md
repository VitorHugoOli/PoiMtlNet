...
- Folder `docs/studies/archive/mtl-protocol-fix/` created alongside `canonical_improvement/` and `merge_design/`.
...
- Doc cross-references updated: `docs/CHANGELOG.md`, `docs/README.md`, `docs/CONCERNS.md` C21, `docs/NORTH_STAR.md`, `docs/AGENT_CONTEXT.md`, `docs/future_works/README.md`, `docs/studies/archive/canonical_improvement/log.md`, `docs/studies/mtl-exploration/README.md` — all now point to this study as the active protocol-axis track.
...
1. Implementing agent must read in order: this log, `INDEX.html` (top-down), `considerations.md`, `docs/CONCERNS.md` C21, `docs/studies/archive/canonical_improvement/log.md` 2026-05-19 final entry, `docs/studies/mtl-exploration/FUTUREWORK_substrate_aware_mtl_balancing.md`.
...
2. Cross-reference notes added to:
   - `docs/studies/archive/canonical_improvement/log.md` — Tier 6 FL-MTL stale log_T caveat
