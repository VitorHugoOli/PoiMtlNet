...
| # | File | Purpose |
|---|------|---------|
| 1 | `docs/studies/archive/canonical_improvement/log.md` | Most recent progress and decisions |
| 2 | `docs/studies/archive/canonical_improvement/INDEX.html` | Full experiment design, top-down. **Read §Execution guidelines + §Falsified history + §Evaluation framework cover-to-cover before any experiment.** |
...
| 6 | `docs/studies/archive/canonical_improvement/considerations.md` | User's original considerations (also audited in INDEX.html §Audit) |
...
- Plots → `docs/studies/archive/canonical_improvement/figs/T{tier}-{id}_*.png`
