...
- `mtl_improvement` T0.2 (mask-audit dependency) should cite this document at `docs/studies/archive/substrate-protocol-cleanup/window_mask_audit.md` and NOT re-audit, per the handoff protocol in [INDEX.md §"D1 ↔ T0.2 handoff"](INDEX.md).
...
- A short mirror entry has been appended to [`docs/studies/archive/mtl_improvement/log.md`](../mtl_improvement/log.md) under 2026-05-28 pointing here.
