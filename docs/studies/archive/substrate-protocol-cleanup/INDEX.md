...
**Drafted:** 2026-05-28
**Predecessor:** [`docs/studies/archive/mtl-protocol-fix/`](../mtl-protocol-fix/) (CLOSED 2026-05-24, v6 final)
**Parallel (independent branch `mtl-improve`):** [`docs/studies/archive/mtl_improvement/`](../mtl_improvement/)
...
- **Output:** `docs/studies/archive/substrate-protocol-cleanup/window_mask_audit.md` with either (a) "no leak found, with code-line citations" or (b) "leak found at <location>, fix proposed, before/after numbers needed".
...
1. The first agent to reach D1 / T0.2 posts an issue-style entry in BOTH `log.md` files (here and in `mtl_improvement/log.md`) declaring "TAKING D1+T0.2 audit; ETA <date>; output at `docs/studies/archive/substrate-protocol-cleanup/window_mask_audit.md`".
