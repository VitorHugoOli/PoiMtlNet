...
**Do NOT treat this study as active without an explicit re-open commit.** If you decide not to re-open it, `git mv docs/studies/archive/hgi_category_injection docs/archive/check2hgi-hgi-category-injection-closed-2026-05-04` and remove it from `docs/studies/README.md` Active studies table.
