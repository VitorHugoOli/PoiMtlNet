...
## Figures
- `docs/studies/archive/mtl_improvement/figs/grad_cosine_tasks.png` — task-gradient orthogonality (AL + FL).
- `docs/studies/archive/mtl_improvement/figs/t4_balancer_scatter_FL.png` — balancers cluster at equal-weight; none beats G.
- `docs/studies/archive/mtl_improvement/figs/t4_loss_weight_trajectories_FL.png` — which balancers actually engage.
