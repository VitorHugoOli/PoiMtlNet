...
- Folder `docs/studies/archive/mtl_improvement/` created. INDEX.html + this log + AGENT_PROMPT.md landed.
...
- User alignment captured via `AskUserQuestion`:
  ...
  - Folder/branch: new folder `docs/studies/archive/mtl_improvement/` + new branch `mtl-improve`.
...
- Per the D1 ↔ T0.2 handoff protocol in [`docs/studies/archive/substrate-protocol-cleanup/INDEX.md`](../substrate-protocol-cleanup/INDEX.md#d1--t02-mask-audit-handoff-mandatory-before-launching-d1), the sister study `substrate-protocol-cleanup` executed the window / causal-mask audit on 2026-05-28 as Tier D1.
- Shared artefact at [`docs/studies/archive/substrate-protocol-cleanup/window_mask_audit.md`](../substrate-protocol-cleanup/window_mask_audit.md).
