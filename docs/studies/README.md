...
|---|---|---|---|
| [`canonical_improvement/`](canonical_improvement/) | **ACTIVE** — 18 experiments across 5 tiers (improving canonical Check2HGI) | branch from `main` (e.g., `check2hgi-canonical-improve`); see `AGENT_PROMPT.md` for the worktree+branching recipe | [`canonical_improvement/AGENT_PROMPT.md`](canonical_improvement/AGENT_PROMPT.md) |
