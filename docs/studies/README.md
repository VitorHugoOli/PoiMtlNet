...
|---|---|---|---|
| [`closing_data/`](closing_data/) | **ACTIVE — paper close-out (MobiWac).** The study that produced the paper board; now switched to the **v17** headline. The heavy spend is done; remaining work is the v17 board completion, split across machines. Origin plans/verdicts/manifests moved to [`closing_data/archive/`](closing_data/archive/README.md). | (main) | [`closing_data/RESULTS_BOARD.md`](closing_data/RESULTS_BOARD.md) (board SSOT) · [`closing_data/v17_completion/`](closing_data/v17_completion/README.md) (remaining runs, per machine) · [`closing_data/log.md`](closing_data/log.md) |
