...
2. **`results/RESULTS_TABLE.md §0`** ⭐ — the **canonical numerical source** for paper tables (v8). All other numbers in this folder reference this.
...
├── results/
│   ├── RESULTS_TABLE.md §0  ⭐            ← canonical numerical source (v8)
...
│   ├── GAP_FILL_WILCOXON.json             ← v8 cat-Δ Wilcoxon (n=20 multi-seed)
