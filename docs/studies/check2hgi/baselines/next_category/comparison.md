...
| **POI-RGNN** | `faithful` (9-step window) | **23.80 ± 1.12** | **27.64 ± 2.34** | **33.35 ± 1.14** | **30.71 ± 0.82** | **32.08 ± 0.70** |
...
| **POI-RGNN** | `faithful` | **39.21 ± 1.97** | **41.04 ± 1.79** | **44.07 ± 0.76** | **41.32 ± 0.52** | **40.59 ± 0.50** |
