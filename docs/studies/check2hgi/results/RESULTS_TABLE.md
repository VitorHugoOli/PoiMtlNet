...
> ⚠ **2026-05-04 v12 — CH19 per-visit counterfactual extended to FL+CA+TX (§0.7); all 5 states now covered. Per-visit share ~89–90% at large states vs 64–72% at small states (two-band pattern).**
>
