...
| # | File | Purpose |
|---|------|---------|
| 1 | `docs/studies/check2hgi/research/canonical_improvement/log.md` | Most recent progress and decisions |
| 2 | `docs/studies/check2hgi/research/canonical_improvement/INDEX.html` | Full experiment design, top-down. **Read §Execution guidelines + §Falsified history + §Evaluation framework cover-to-cover before any experiment.** |
| 3 | `docs/studies/check2hgi/research/merge_design/STUDY_BRIEFING.html` | Big-picture context of the parallel merge-design track |
| 4 | `docs/studies/check2hgi/research/merge_design/STATE.md` | What's settled vs open in merge-design (especially Phase 11) |
| 5 | `docs/studies/check2hgi/research/merge_design/AUDIT_HGI_GAP.md` | Why HGI beats canonical on reg, and what's been falsified |
| 6 | `docs/studies/check2hgi/research/canonical_improvement/considerations.md` | User's original considerations (also audited in INDEX.html §Audit) |
| 7 | `docs/studies/check2hgi/AGENT_CONTEXT.md` | Study-wide workflow |
| 8 | `docs/studies/check2hgi/NORTH_STAR.md` | Canonical training recipe (B9 MTL) |
...
1. **Create the dedicated git worktree first**. Branch `check2hgi-canonical-improve` from `check2hgi-up`. Do not contaminate other ongoing work.

   ```bash
   git fetch origin
   git worktree add ../worktree-check2hgi-canonical-improve -b check2hgi-canonical-improve check2hgi-up
...
- Raw per-fold metrics → `docs/studies/check2hgi/results/canonical_improvement/T{tier}-{id}_{state}_{seed}_{folds}f{epochs}ep.json`
- Paired-test JSONs → `docs/studies/check2hgi/results/paired_tests/canonical_improvement/T{tier}-{id}_paired.json`
- Plots → `docs/studies/check2hgi/research/canonical_improvement/figs/T{tier}-{id}_*.png`
...
```
docs/studies/check2hgi/research/canonical_improvement/
...
docs/studies/check2hgi/research/merge_design/
...
docs/studies/check2hgi/results/
