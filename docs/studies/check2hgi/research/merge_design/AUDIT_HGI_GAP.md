...
Sources:
- AL/AZ: `docs/studies/check2hgi/results/paired_tests/design_audit_al_az.json`
- FL design rows: `docs/studies/check2hgi/results/P1/region_head_florida_region_5f_50ep_STL_FLORIDA_design_<x>_reg_gethard_pf_5f50ep_leakfree.json`
...
- `scripts/probe/build_design_*.py` — every design builder writes
  ...
  as a label.
- `docs/studies/check2hgi/results/P1/region_head_florida_region_*` filenames
...
λ=0.1) is logged at
`docs/studies/check2hgi/results/P1/region_head_alabama_..._design_j_l0_3_..._leakfree.json`
