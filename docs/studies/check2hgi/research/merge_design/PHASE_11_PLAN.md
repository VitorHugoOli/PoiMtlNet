...
- `docs/studies/check2hgi/results/P1/region_head_{state}_..._c2p_hardneg_0_25_leakfree.json`
- `docs/studies/check2hgi/results/paired_tests/substrate_audit_S1.json`
