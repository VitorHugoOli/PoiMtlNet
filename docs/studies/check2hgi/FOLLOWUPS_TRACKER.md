...
> **F49 closed 2026-04-27** (architecture attribution, AL+AZ+FL n=5): cat-supervision transfer null on all 3 states; H3-alt reg lift on AL is architecture-dominant (+6.48 pp). See `research/F49_LAMBDA0_DECOMPOSITION_RESULTS.md`. Open: F37 STL FL F21c (closes Layer 3 absolute architectural Δ on FL).
