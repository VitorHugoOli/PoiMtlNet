...
- **B8a STAN (AL + AZ):** `docs/results/P1/region_head_{alabama,arizona}_region_5f_50ep_STAN_*_5f50ep.json`. See `docs/findings/SOTA_STAN_BASELINE.md`.
- **A5, A4:** `docs/results/P1_5b/next_category_alabama_{check2hgi,hgi}_5f_50ep_fair.json`
- **A11:** `docs/results/P1_5b/next_category_florida_check2hgi_1f_50ep_fair.json`
- **A8:** `docs/results/P2/ablation_06_crossattn_al_5f50ep.json`
- **A6, B10:** `docs/results/P2/validate_dselectk_pcgrad_gru_al_5f_50ep.json`
- **A7, B11:** `docs/results/P2/ablation_04_mtlora_r8_al_5f50ep.json`
- **A12, B20:** `docs/results/P2/validate_fl_dselectk_pcgrad_gru_1f_50ep.json`
- **B8:** `docs/results/P1/region_head_alabama_region_5f_50ep_E_confirm_gru_region.json`
- **B7:** `docs/results/P1/region_head_alabama_region_5f_50ep_E_confirm_tcn_region.json`
- **B19:** `docs/results/P1/region_head_florida_region_5f_50ep_E_confirm_fl_gru_region.json`
- **B9:** `docs/results/P1/region_head_alabama_region_5f_50ep_P15_hgi_al_tcn.json`
- **B5, B17:** `docs/results/P0/simple_baselines/{alabama,florida}/next_region.json`
- **B12:** `docs/results/P2/ablation_02_1227.json`
