...
- AL: `docs/results/P2/rerun_R3_crossattn_fairlr_al_5f50ep.json`
- AZ: `docs/results/P2/az1_crossattn_fairlr_5f50ep.json`
- FL: `docs/results/P2/fl_crossattn_fairlr_1f50ep.json`
- STL references: `docs/results/P1_5b/next_category_{alabama,arizona,florida}_check2hgi_*_fair.json`
- Region STL: `docs/results/P1/region_head_{alabama,arizona,florida}_region_*_gru_*.json`
