...
- STL fair baselines: `docs/results/P1_5b/next_category_alabama_check2hgi_5f_50ep_fair.json` + `results/P1/region_head_alabama_region_5f_50ep_E_confirm_gru_region.json`
