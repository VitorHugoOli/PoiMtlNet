...
- R1–R5 raw summaries: `docs/results/P2/rerun_R{1..5}_*_fairlr_al_5f50ep.json`
- Unfair-LR comparisons retained: `docs/results/P2/ablation_{01..06}_*.json`
- max_lr sweep (step 7): `docs/results/P2/ablation_07_maxlr_*.json` (0.01 QUARANTINED per user note — Mac went idle)
- Architectural overhead: `docs/results/P2/ablation_architectural_overhead.md` (pre-rerun)
- Strategic framing + SOTA research: `docs/findings/`
