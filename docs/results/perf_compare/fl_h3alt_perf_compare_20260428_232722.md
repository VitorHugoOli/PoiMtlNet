...
Reference: F48-H3-alt FL 5f × 50ep, seed 42, cat F1 67.92 ± 0.72, reg Acc@10_indist 71.96 ± 0.68 (from `docs/NORTH_STAR.md`).
...
| **compile** | — | — | — | — | _missing_ |
| **bs2048** | 67.63 ± 0.72 | -0.29 pp (0.40σ) ✓ | 59.04 ± 12.00 | -12.92 pp (19.00σ) ✗ | `mtlnet_lr1.0e-04_bs2048_ep50_20260428_2307` |
