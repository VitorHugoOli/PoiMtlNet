...
```
docs/paper/methods.md                       (Methods §3 v0)
docs/paper/results.md                       (Results §4 v0 — with P4 Wilcoxon)
docs/paper/appendix_methodology.md          (Appendix A — F49 Layer 2 v0)
docs/paper/limitations.md                   (Limitations §6 v0)
docs/scope/task_pivot_memo.md               (next_poi → next_category memo)
docs/scope/ch15_rename_proposal.md          (CH15 ID-reuse decision A/B/C)
docs/scope/ch14_ch10_p02_decisions.md       (run-or-retire proposals)
docs/launch_plans/f33_f36_colab.md          (FL Phase-2 Colab launch plan)
docs/launch_plans/ca_tx_upstream.md         (P3 5-stage CA+TX handoff)
...
docs/review/2026-04-28_post_phase1_overview_and_gap_audit.md
                                                              (full overview/gap audit)
docs/review/2026-04-28_morning_briefing.md  (this file)
```
...
1. **`docs/review/2026-04-28_post_phase1_overview_and_gap_audit.md`** — the full overview + gap audit you asked for; visible in the review folder when SSD is back.
...
/tmp/check2hgi_drafts/p4_p5_wilcoxon.py
  → docs/findings/p4_p5_wilcoxon_offline.py (preserve the no-scipy version)

/tmp/check2hgi_drafts/p4_p5_wilcoxon_results.json
  → docs/results/paired_tests/F49_decomposition_wilcoxon.json (rename)
...
/tmp/check2hgi_drafts/N7d_limitations_section.md
  ...
  → OR individual files: docs/paper/{methods,results,appendix,limitations}.md
...
cat "/Volumes/Vitor's SSD/ingred/.claude/worktrees/check2hgi-mtl/docs/review/2026-04-28_post_phase1_overview_and_gap_audit.md" | head

# 2. Copy drafts in
mkdir -p "/Volumes/Vitor's SSD/ingred/.claude/worktrees/check2hgi-mtl/docs/studies/check2hgi/paper"
cp /tmp/check2hgi_drafts/N7a_methods_section.md           "/Volumes/Vitor's SSD/ingred/.claude/worktrees/check2hgi-mtl/docs/paper/methods.md"
cp /tmp/check2hgi_drafts/N7b_results_section.md           "/Volumes/Vitor's SSD/ingred/.claude/worktrees/check2hgi-mtl/docs/paper/results.md"
cp /tmp/check2hgi_drafts/N7c_methodological_appendix.md   "/Volumes/Vitor's SSD/ingred/.claude/worktrees/check2hgi-mtl/docs/paper/appendix_methodology.md"
cp /tmp/check2hgi_drafts/N7d_limitations_section.md       "/Volumes/Vitor's SSD/ingred/.claude/worktrees/check2hgi-mtl/docs/paper/limitations.md"

# 3. Move the Wilcoxon results
cp /tmp/check2hgi_drafts/p4_p5_wilcoxon_results.json     "/Volumes/Vitor's SSD/ingred/.claude/worktrees/check2hgi-mtl/docs/results/paired_tests/F49_decomposition_wilcoxon.json"
...
cp /tmp/check2hgi_drafts/N2a_task_pivot_memo.md   "/Volumes/Vitor's SSD/ingred/.claude/worktrees/check2hgi-mtl/docs/scope/task_pivot_memo.md"
cp /tmp/check2hgi_drafts/N2b_ch15_rename.md       "/Volumes/Vitor's SSD/ingred/.claude/worktrees/check2hgi-mtl/docs/scope/ch15_rename_proposal.md"
cp /tmp/check2hgi_drafts/N5_run_or_retire.md      "/Volumes/Vitor's SSD/ingred/.claude/worktrees/check2hgi-mtl/docs/scope/ch14_ch10_p02_decisions.md"

# 5. Move launch plans
cp /tmp/check2hgi_drafts/N6_F33_F36_colab_launch_plan.md  "/Volumes/Vitor's SSD/ingred/.claude/worktrees/check2hgi-mtl/docs/launch_plans/f33_f36_colab.md"
cp /tmp/check2hgi_drafts/N8_ca_tx_upstream_handoff.md     "/Volumes/Vitor's SSD/ingred/.claude/worktrees/check2hgi-mtl/docs/launch_plans/ca_tx_upstream.md"

# 6. Verify and commit
cd "/Volumes/Vitor's SSD/ingred/.claude/worktrees/check2hgi-mtl"
git status
git diff --stat
git add docs/paper/ docs/scope/ docs/launch_plans/ docs/results/paired_tests/F49_decomposition_wilcoxon.json scripts/analysis/p4_p5_wilcoxon_offline.py
...
- Overview that DID land in repo: `docs/review/2026-04-28_post_phase1_overview_and_gap_audit.md`
