...
`docs/studies/archive/fusion/issues/HGI_LEAKAGE_AUDIT.md` (technical audit),
...
Archived at `docs/studies/archive/fusion/results/P0/leakage_ablation/fclass_purity.json`.
...
doc (`docs/studies/archive/fusion/issues/HGI_LEAKAGE_AUDIT.md` §9). C29 is now cross-state
