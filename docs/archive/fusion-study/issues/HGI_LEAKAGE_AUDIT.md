...
- One JSON per arm under `docs/studies/archive/fusion/results/P0/leakage_ablation/alabama/{baseline,A,B,AB}.json`.
- Summary table in `docs/studies/archive/fusion/results/P0/leakage_ablation/README.md`.
...
`docs/studies/archive/fusion/results/P0/leakage_ablation/fclass_purity.json`.
...
`docs/studies/archive/fusion/results/P0/leakage_ablation/alabama/README.md`.
...
run log at `docs/studies/archive/fusion/results/P0/leakage_ablation/florida/run_log.json`.
...
4. **C29 (new claim):** add to `CLAIMS_AND_HYPOTHESES.md` — "Category F1
   ...
   `docs/studies/archive/fusion/results/P0/leakage_ablation/alabama/C_fclass_shuffle/`."
