...
| `stl_hgi` | AL | `docs/results/baselines/REHDM_STL_STUDY_v3_al_hgi_5f50ep_fold{0..4}.json` |
| `stl_hgi` | AZ | `docs/results/baselines/REHDM_STL_STUDY_v3_az_hgi_5f50ep_fold{0..4}.json` |
| `stl_hgi` | FL | `docs/results/baselines/REHDM_STL_STUDY_v3_fl_hgi_5f50ep_fold{0..4}.json` |
| `stl_*` paper-protocol replicates | AL/AZ | `docs/results/baselines/REHDM_STL_*_5x50_run{0..4}.json` (archived; not used in comparison) |
...
Aggregated summaries at `docs/results/baselines/REHDM_*_summary.json`.
