...
This folder is the read-from for the paper's baseline tables. The raw training JSONs continue to live under `docs/results/` (per the existing study layout); this folder *aggregates* them by baseline + state + task.
...
| Variant | State | JSON |
|---|---|---|
| `faithful` | AL | `docs/results/baselines/...` |
| `stl_check2hgi` | AL | `docs/results/P1/...` |
| ...      | ... | ... |
```
  ...
  "baselines": {
    "stan": {
      "faithful": {
        ...
        "date": "2026-04-26",
        "source_json": "docs/results/baselines/faithful_stan_alabama_5f_50ep_FAITHFUL_STAN_al_5f50ep_v4.json"
      },
      "stl_check2hgi": { "...": "..." },
      "stl_hgi":       { "...": "..." }
    },
