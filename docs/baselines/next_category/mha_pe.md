...
| Variant | State | JSON |
|---|---|---|
| `faithful` | AL | `docs/results/baselines/faithful_mha_pe_alabama_5f_11ep_FAITHFUL_MHAPE_al_5f11ep.json` |
| `faithful` | AZ | `docs/results/baselines/faithful_mha_pe_arizona_5f_11ep_FAITHFUL_MHAPE_az_5f11ep.json` |
| `faithful` | FL | `docs/results/baselines/faithful_mha_pe_florida_5f_11ep_FAITHFUL_MHAPE_fl_5f11ep.json` |
