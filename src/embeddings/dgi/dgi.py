...
from embeddings.dgi.model.DGIModule import DGIModule
...
def create_embedding(city, args):
    output_folder = IoPaths.DGI.get_state_dir(city)
    ...
    # Carregando os dados
    with open(IoPaths.DGI.get_inter_file(city), 'rb') as handle:
    ...
    output_path = IoPaths.get_embedd(city, EmbeddingEngine.DGI)
...
if __name__ == '__main__':
    ...
    create_embedding(city=args.city, args=args)
