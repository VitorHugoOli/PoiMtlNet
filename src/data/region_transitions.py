...
Usage::
    ...
    python pipelines/reproducibility/build_region_transitions.pipe.py --state alabama

    # per-fold (clean — no val leakage)
    python pipelines/reproducibility/build_region_transitions.pipe.py --state florida --per-fold
"""
...
def save(
    ...
    default). See ``src/training/runners/mtl_cv.py`` for the load-side guard.
    """
