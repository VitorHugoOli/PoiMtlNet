...
2. **Collect state.** Run:
   ...
   - Read `docs/studies/state.json` directly for full test details in the target phase.
   - Read the corresponding `docs/studies/phases/<phase>_*.md` — it defines the phase gate and expected tests.
   - Read `docs/studies/CLAIMS_AND_HYPOTHESES.md` — for claim definitions touched by the phase.
...
7. **Write a phase summary.** Append / update `docs/studies/results/<phase>/SUMMARY.md` with:
