...
\usepackage[brazil]{babel}
\usepackage[utf8]{inputenc}
% Body is English; babel[brazil] is kept only for the Portuguese \resumo.
% Override the auto-generated caption/reference labels so they render in English.
...
\title{ST-MTLNet: Spatio-Temporal Representations \\of Points of Interest for Multi-Task Learning}
...
The authors would like to thank the Ministry of Science, Technology and Innovation (MCTI), the Manna Team, the Araucária Foundation, Softex, CNPq (project number 421548/2022-3), the Minas Gerais State Research Foundation (FAPEMIG), and CAPES for their support.
