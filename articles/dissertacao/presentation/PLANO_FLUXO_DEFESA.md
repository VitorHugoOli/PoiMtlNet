...
| **A ideia infomax** (o objetivo comum a DGI/HGI/Check2HGI) | **2.4** | 3.2A, 4.1A, 5.2 | "o mesmo objetivo da Seção 2, um nível abaixo" |
| Linhagem de modelos (Tabela 1) + diagrama de níveis | **2.4** | 3, 4, 5.2 | apontar para a Tabela 1 |
| **Linhagem de representações** (one-hot → distribuídas → redes de grafo) | **2.4** | 5.2 | "a escada da Seção 2" — ⚠ **linha acrescentada 2026-08-25**: o slide entrou em 22/08 e nunca foi registrado aqui, o que deixava a **regra 4 formalmente violada** |
