...
%    agora tem 3,9mm.
%
% RODADA 24 -- "Delaunay" no vao (pedido do autor).  "Original graph" subiu para
% CIMA da moldura e o vao entre os dois grafos passou a carregar o nome do
% metodo.  Nao e' ajuste local: e' o mesmo lugar onde a chapa do HGI poe
% "Delaunay / Geographic adjacency" e a do Check2HGI poe "directed visit
% sequence".  AS TRES CHAPAS PASSAM A NOMEAR A CONSTRUCAO DO GRAFO NO MESMO
% VAO -- vira gramatica, nao tres coincidencias.  (Delaunay confere com o
% codigo: `dgi/preprocess.py:139-166`.)  Versao anterior guardada em
% `dgi_flow_v1_semdelaunay.tex`.
%
% ⚠ E CUSTOU ALTURA: 50,4 -> 55,8 mm, e o slide transbordava 12,83pt.  A `ppt`
%   gastou a ultima alavanca dela (itemize -> marcadores manuais, 5pt) e ainda
%   faltavam 2,8mm.  Recuperados 3,0 assim:
%     `inner sep` da moldura 1,5 -> 1,0 mm  (2 molduras x 2 lados) ....... 2,0
%     folga das duas legendas   1,2 -> 0,7 mm ........................... 1,0
%   O GRAFO NAO ENCOLHEU.  Encolher os nos daria mais 1mm e foi descartado de
%   proposito: o tamanho do pictograma e' o que faz as tres chapas parecerem
%   parentes -- pagar o milimetro com o parentesco faria o slide caber e a
%   razao de caber desaparecer.
%
% ⚠ ARMADILHA, para quem for apertar de novo: encurtar o `inner sep` ABRE o vao
%   entre as molduras, porque as bordas recuam em direcoes opostas.  Mexer so'
%   nele recupera METADE e deixa o "Delaunay" boiando -- o numero fecha e o
%   desenho piora.  Por isso o deslocamento foi de -2,46 para -2,36 junto: o vao
%   ficou com a folga IDENTICA a de antes.  Final 138,6 x 52,8 mm, `Overfull`
%   zero no slide (verificado por build pela `ppt`, nao por aritmetica).
%
...
\node[lbl, above=0.7mm of gposbox, text width=2.4cm] (cappos) {Original graph};

% ---------------------------------------------------- grafo CORROMPIDO
% Mesmas coordenadas, mesmas arestas: a corrupcao e' na correspondencia
% no'<->feature, nao na topologia.
\begin{scope}[local bounding box=gneg, shift={(0,-2.36)}]
...
\path (gposbox.south) -- (gnegbox.north) node[midway, lbl] {\textbf{Delaunay}};
\node[lbl, text=alert, below=0.7mm of gnegbox, text width=2.75cm] (capneg)
      {Shuffled features};
