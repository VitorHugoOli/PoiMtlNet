...
\textbf{\textcolor{crim}{O relógio.}} Os tempos abaixo são os do plano e somam 47:50.
...
\textbf{FUNDAMENTOS --- dito uma vez} & S8--S14 & 6:05 & \rule{32mm}{0.4pt} \\
\textbf{MTLnet --- Cap. 3 (CBIC)} & S17--S25 & 15:50 & \rule{32mm}{0.4pt} \\
\textbf{ST-MTLNet --- Cap. 4 (CoUrb)} & S26--S32 & 21:50 & \rule{32mm}{0.4pt} \\
\textbf{Check2HGI --- Cap. 5 (MobiWac)} & S33--S49 & 42:20 & \rule{32mm}{0.4pt} \\
\textbf{CONCLUSÃO --- a resposta condicional} & S50--S55 & 47:50 & \rule{32mm}{0.4pt} \\
\hline
\end{tabular}
\clearpage
...
\begin{tcolorbox}[breakable,colback=white,colframe=teal!55,boxrule=0.6pt,arc=2pt,left=3mm,right=3mm,top=2mm,bottom=2mm]
{\small\color{soft}\textbf{S13} $\cdot$ slide \textbf{7} $\cdot$ PDF p.10 $\cdot$ 35 s $\cdot$ fim previsto \textbf{5:35}}\par\vspace{1mm}
...
\end{tcolorbox}\vspace{2mm}
\begin{tcolorbox}[breakable,colback=white,colframe=teal!55,boxrule=0.6pt,arc=2pt,left=3mm,right=3mm,top=2mm,bottom=2mm]
{\small\color{soft}\textbf{S14} $\cdot$ slide \textbf{8} $\cdot$ PDF p.11 $\cdot$ 30 s $\cdot$ fim previsto \textbf{6:05}}\par\vspace{1mm}
...
\end{tcolorbox}\vspace{2mm}
\begin{tcolorbox}[breakable,colback=white,colframe=teal!55,boxrule=0.6pt,arc=2pt,left=3mm,right=3mm,top=2mm,bottom=2mm]
{\small\color{soft}\textbf{S8} $\cdot$ slide \textbf{9} $\cdot$ PDF p.12 $\cdot$ 75 s $\cdot$ fim previsto \textbf{7:20}}\par\vspace{1mm}
{\large\bfseries\color{ink} The line this work stands on, and the one idea on it}\par\vspace{2mm}
...
\end{tcolorbox}\vspace{2mm}
\begin{tcolorbox}[breakable,colback=white,colframe=teal!55,boxrule=0.6pt,arc=2pt,left=3mm,right=3mm,top=2mm,bottom=2mm]
{\small\color{soft}\textbf{S10} $\cdot$ slide \textbf{11} $\cdot$ PDF p.14 $\cdot$ 55 s $\cdot$ fim previsto \textbf{8:55}}\par\vspace{1mm}
...
\end{tcolorbox}\vspace{2mm}
\begin{tcolorbox}[breakable,colback=white,colframe=teal!55,boxrule=0.6pt,arc=2pt,left=3mm,right=3mm,top=2mm,bottom=2mm]
{\small\color{soft}\textbf{S11} $\cdot$ slide \textbf{12} $\cdot$ PDF p.15 $\cdot$ 35 s $\cdot$ fim previsto \textbf{9:30}}\par\vspace{1mm}
...
\end{tcolorbox}\vspace{2mm}
\begin{tcolorbox}[breakable,colback=white,colframe=teal!55,boxrule=0.6pt,arc=2pt,left=3mm,right=3mm,top=2mm,bottom=2mm]
{\small\color{soft}\textbf{S12} $\cdot$ slide \textbf{13} $\cdot$ PDF p.16 $\cdot$ 50 s $\cdot$ fim previsto \textbf{10:20}}\par\vspace{1mm}
...
\end{tcolorbox}\vspace{2mm}
\begin{tcolorbox}[breakable,colback=white,colframe=teal!55,boxrule=0.6pt,arc=2pt,left=3mm,right=3mm,top=2mm,bottom=2mm]
{\small\color{soft}\textbf{S18} $\cdot$ slide \textbf{15} $\cdot$ PDF p.19 $\cdot$ 45 s $\cdot$ fim previsto \textbf{11:35}}\par\vspace{1mm}
...
\end{tcolorbox}\vspace{2mm}
\begin{tcolorbox}[breakable,colback=white,colframe=teal!55,boxrule=0.6pt,arc=2pt,left=3mm,right=3mm,top=2mm,bottom=2mm]
{\small\color{soft}\textbf{S19} $\cdot$ slide \textbf{16} $\cdot$ PDF p.20 $\cdot$ 45 s $\cdot$ fim previsto \textbf{12:20}}\par\vspace{1mm}
...
\end{tcolorbox}\vspace{2mm}
\begin{tcolorbox}[breakable,colback=white,colframe=teal!55,boxrule=0.6pt,arc=2pt,left=3mm,right=3mm,top=2mm,bottom=2mm]
{\small\color{soft}\textbf{S20} $\cdot$ slide \textbf{17} $\cdot$ PDF p.21 $\cdot$ 30 s $\cdot$ fim previsto \textbf{12:50}}\par\vspace{1mm}
...
\end{tcolorbox}\vspace{2mm}
\begin{tcolorbox}[breakable,colback=white,colframe=teal!55,boxrule=0.6pt,arc=2pt,left=3mm,right=3mm,top=2mm,bottom=2mm]
{\small\color{soft}\textbf{S21} $\cdot$ slide \textbf{18} $\cdot$ PDF p.22 $\cdot$ 40 s $\cdot$ fim previsto \textbf{13:30}}\par\vspace{1mm}
...
\end{tcolorbox}\vspace{2mm}
\begin{tcolorbox}[breakable,colback=white,colframe=teal!55,boxrule=0.6pt,arc=2pt,left=3mm,right=3mm,top=2mm,bottom=2mm]
{\small\color{soft}\textbf{S22} $\cdot$ slide \textbf{19} $\cdot$ PDF p.23 $\cdot$ 40 s $\cdot$ fim previsto \textbf{14:10}}\par\vspace{1mm}
...
\end{tcolorbox}\vspace{2mm}
\begin{tcolorbox}[breakable,colback=white,colframe=teal!55,boxrule=0.6pt,arc=2pt,left=3mm,right=3mm,top=2mm,bottom=2mm]
{\small\color{soft}\textbf{S23} $\cdot$ slide \textbf{20} $\cdot$ PDF p.24 $\cdot$ 55 s $\cdot$ fim previsto \textbf{15:05}}\par\vspace{1mm}
...
\end{tcolorbox}\vspace{2mm}
\begin{tcolorbox}[breakable,colback=white,colframe=teal!55,boxrule=0.6pt,arc=2pt,left=3mm,right=3mm,top=2mm,bottom=2mm]
{\small\color{soft}\textbf{S24} $\cdot$ slide \textbf{21} $\cdot$ PDF p.25 $\cdot$ 25 s $\cdot$ fim previsto \textbf{15:30}}\par\vspace{1mm}
...
\end{tcolorbox}\vspace{2mm}
\begin{tcolorbox}[breakable,colback=white,colframe=teal!55,boxrule=0.6pt,arc=2pt,left=3mm,right=3mm,top=2mm,bottom=2mm]
{\small\color{soft}\textbf{S25} $\cdot$ slide \textbf{22} $\cdot$ PDF p.26 $\cdot$ 20 s $\cdot$ fim previsto \textbf{15:50}}\par\vspace{1mm}
...
\begin{tcolorbox}[breakable,colback=white,colframe=teal!55,boxrule=0.6pt,arc=2pt,left=3mm,right=3mm,top=2mm,bottom=2mm]
{\small\color{soft}\textbf{S26} $\cdot$ slide \textbf{23} $\cdot$ PDF p.28 $\cdot$ 40 s $\cdot$ fim previsto \textbf{16:30}}\par\vspace{1mm}
...
\end{tcolorbox}\vspace{2mm}
\begin{tcolorbox}[breakable,colback=white,colframe=teal!55,boxrule=0.6pt,arc=2pt,left=3mm,right=3mm,top=2mm,bottom=2mm]
{\small\color{soft}\textbf{S27} $\cdot$ slide \textbf{25} $\cdot$ PDF p.30 $\cdot$ 55 s $\cdot$ fim previsto \textbf{17:25}}\par\vspace{1mm}
...
\end{tcolorbox}\vspace{2mm}
\begin{tcolorbox}[breakable,colback=white,colframe=teal!55,boxrule=0.6pt,arc=2pt,left=3mm,right=3mm,top=2mm,bottom=2mm]
{\small\color{soft}\textbf{S28} $\cdot$ slide \textbf{26} $\cdot$ PDF p.31 $\cdot$ 60 s $\cdot$ fim previsto \textbf{18:25}}\par\vspace{1mm}
...
\end{tcolorbox}\vspace{2mm}
\begin{tcolorbox}[breakable,colback=white,colframe=teal!55,boxrule=0.6pt,arc=2pt,left=3mm,right=3mm,top=2mm,bottom=2mm]
{\small\color{soft}\textbf{S29} $\cdot$ slide \textbf{27} $\cdot$ PDF p.32 $\cdot$ 45 s $\cdot$ fim previsto \textbf{19:10}}\par\vspace{1mm}
...
\end{tcolorbox}\vspace{2mm}
\begin{tcolorbox}[breakable,colback=white,colframe=teal!55,boxrule=0.6pt,arc=2pt,left=3mm,right=3mm,top=2mm,bottom=2mm]
{\small\color{soft}\textbf{S30} $\cdot$ slide \textbf{28} $\cdot$ PDF p.34 $\cdot$ 60 s $\cdot$ fim previsto \textbf{20:10}}\par\vspace{1mm}
...
\end{tcolorbox}\vspace{2mm}
\begin{tcolorbox}[breakable,colback=white,colframe=teal!55,boxrule=0.6pt,arc=2pt,left=3mm,right=3mm,top=2mm,bottom=2mm]
{\small\color{soft}\textbf{S31} $\cdot$ slide \textbf{29} $\cdot$ PDF p.35 $\cdot$ 65 s $\cdot$ fim previsto \textbf{21:15}}\par\vspace{1mm}
...
\end{tcolorbox}\vspace{2mm}
\begin{tcolorbox}[breakable,colback=white,colframe=teal!55,boxrule=0.6pt,arc=2pt,left=3mm,right=3mm,top=2mm,bottom=2mm]
{\small\color{soft}\textbf{S32} $\cdot$ slide \textbf{30} $\cdot$ PDF p.36 $\cdot$ 35 s $\cdot$ fim previsto \textbf{21:50}}\par\vspace{1mm}
...
\begin{tcolorbox}[breakable,colback=white,colframe=teal!55,boxrule=0.6pt,arc=2pt,left=3mm,right=3mm,top=2mm,bottom=2mm]
{\small\color{soft}\textbf{S33} $\cdot$ slide \textbf{31} $\cdot$ PDF p.38 $\cdot$ 60 s $\cdot$ fim previsto \textbf{22:50}}\par\vspace{1mm}
...
\end{tcolorbox}\vspace{2mm}
\begin{tcolorbox}[breakable,colback=white,colframe=teal!55,boxrule=0.6pt,arc=2pt,left=3mm,right=3mm,top=2mm,bottom=2mm]
{\small\color{soft}\textbf{S34} $\cdot$ slide \textbf{32} $\cdot$ PDF p.39 $\cdot$ 35 s $\cdot$ fim previsto \textbf{23:25}}\par\vspace{1mm}
...
\end{tcolorbox}\vspace{2mm}
\begin{tcolorbox}[breakable,colback=white,colframe=teal!55,boxrule=0.6pt,arc=2pt,left=3mm,right=3mm,top=2mm,bottom=2mm]
{\small\color{soft}\textbf{S35} $\cdot$ slide \textbf{33} $\cdot$ PDF p.40 $\cdot$ 25 s $\cdot$ fim previsto \textbf{23:50}}\par\vspace{1mm}
...
\end{tcolorbox}\vspace{2mm}
\begin{tcolorbox}[breakable,colback=white,colframe=teal!55,boxrule=0.6pt,arc=2pt,left=3mm,right=3mm,top=2mm,bottom=2mm]
{\small\color{soft}\textbf{S36} $\cdot$ slide \textbf{34} $\cdot$ PDF p.41 $\cdot$ 80 s $\cdot$ fim previsto \textbf{25:10}}\par\vspace{1mm}
...
\end{tcolorbox}\vspace{2mm}
\begin{tcolorbox}[breakable,colback=white,colframe=teal!55,boxrule=0.6pt,arc=2pt,left=3mm,right=3mm,top=2mm,bottom=2mm]
{\small\color{soft}\textbf{S37} $\cdot$ slide \textbf{35} $\cdot$ PDF p.42 $\cdot$ 70 s $\cdot$ fim previsto \textbf{26:20}}\par\vspace{1mm}
...
\end{tcolorbox}\vspace{2mm}
\begin{tcolorbox}[breakable,colback=white,colframe=teal!55,boxrule=0.6pt,arc=2pt,left=3mm,right=3mm,top=2mm,bottom=2mm]
{\small\color{soft}\textbf{S38} $\cdot$ slide \textbf{36} $\cdot$ PDF p.43 $\cdot$ 90 s $\cdot$ fim previsto \textbf{27:50}}\par\vspace{1mm}
...
\end{tcolorbox}\vspace{2mm}
\begin{tcolorbox}[breakable,colback=white,colframe=teal!55,boxrule=0.6pt,arc=2pt,left=3mm,right=3mm,top=2mm,bottom=2mm]
{\small\color{soft}\textbf{S39} $\cdot$ slide \textbf{37} $\cdot$ PDF p.44 $\cdot$ 90 s $\cdot$ fim previsto \textbf{29:20}}\par\vspace{1mm}
...
\end{tcolorbox}\vspace{2mm}
\begin{tcolorbox}[breakable,colback=white,colframe=teal!55,boxrule=0.6pt,arc=2pt,left=3mm,right=3mm,top=2mm,bottom=2mm]
{\small\color{soft}\textbf{S40} $\cdot$ slide \textbf{38} $\cdot$ PDF p.45 $\cdot$ 90 s $\cdot$ fim previsto \textbf{30:50}}\par\vspace{1mm}
...
\end{tcolorbox}\vspace{2mm}
\begin{tcolorbox}[breakable,colback=white,colframe=teal!55,boxrule=0.6pt,arc=2pt,left=3mm,right=3mm,top=2mm,bottom=2mm]
{\small\color{soft}\textbf{S41} $\cdot$ slide \textbf{39} $\cdot$ PDF p.46 $\cdot$ 60 s $\cdot$ fim previsto \textbf{31:50}}\par\vspace{1mm}
...
\end{tcolorbox}\vspace{2mm}
\begin{tcolorbox}[breakable,colback=white,colframe=teal!55,boxrule=0.6pt,arc=2pt,left=3mm,right=3mm,top=2mm,bottom=2mm]
{\small\color{soft}\textbf{S42} $\cdot$ slide \textbf{40} $\cdot$ PDF p.47 $\cdot$ 65 s $\cdot$ fim previsto \textbf{32:55}}\par\vspace{1mm}
...
\end{tcolorbox}\vspace{2mm}
\begin{tcolorbox}[breakable,colback=white,colframe=teal!55,boxrule=0.6pt,arc=2pt,left=3mm,right=3mm,top=2mm,bottom=2mm]
{\small\color{soft}\textbf{S43} $\cdot$ slide \textbf{41} $\cdot$ PDF p.48 $\cdot$ 65 s $\cdot$ fim previsto \textbf{34:00}}\par\vspace{1mm}
...
\end{tcolorbox}\vspace{2mm}
\begin{tcolorbox}[breakable,colback=white,colframe=teal!55,boxrule=0.6pt,arc=2pt,left=3mm,right=3mm,top=2mm,bottom=2mm]
{\small\color{soft}\textbf{S44} $\cdot$ slide \textbf{42} $\cdot$ PDF p.49 $\cdot$ 65 s $\cdot$ fim previsto \textbf{35:05}}\par\vspace{1mm}
...
\end{tcolorbox}\vspace{2mm}
\begin{tcolorbox}[breakable,colback=white,colframe=teal!55,boxrule=0.6pt,arc=2pt,left=3mm,right=3mm,top=2mm,bottom=2mm]
{\small\color{soft}\textbf{S45} $\cdot$ slide \textbf{43} $\cdot$ PDF p.50 $\cdot$ 110 s $\cdot$ fim previsto \textbf{36:55}}\par\vspace{1mm}
...
\end{tcolorbox}\vspace{2mm}
\begin{tcolorbox}[breakable,colback=white,colframe=teal!55,boxrule=0.6pt,arc=2pt,left=3mm,right=3mm,top=2mm,bottom=2mm]
{\small\color{soft}\textbf{S46} $\cdot$ slide \textbf{44} $\cdot$ PDF p.51 $\cdot$ 120 s $\cdot$ fim previsto \textbf{38:55}}\par\vspace{1mm}
...
\end{tcolorbox}\vspace{2mm}
\begin{tcolorbox}[breakable,colback=white,colframe=teal!55,boxrule=0.6pt,arc=2pt,left=3mm,right=3mm,top=2mm,bottom=2mm]
{\small\color{soft}\textbf{S47} $\cdot$ slide \textbf{45} $\cdot$ PDF p.52 $\cdot$ 100 s $\cdot$ fim previsto \textbf{40:35}}\par\vspace{1mm}
...
\end{tcolorbox}\vspace{2mm}
\begin{tcolorbox}[breakable,colback=white,colframe=teal!55,boxrule=0.6pt,arc=2pt,left=3mm,right=3mm,top=2mm,bottom=2mm]
{\small\color{soft}\textbf{S48} $\cdot$ slide \textbf{46} $\cdot$ PDF p.53 $\cdot$ 75 s $\cdot$ fim previsto \textbf{41:50}}\par\vspace{1mm}
...
\end{tcolorbox}\vspace{2mm}
\begin{tcolorbox}[breakable,colback=white,colframe=teal!55,boxrule=0.6pt,arc=2pt,left=3mm,right=3mm,top=2mm,bottom=2mm]
{\small\color{soft}\textbf{S49} $\cdot$ slide \textbf{47} $\cdot$ PDF p.55 $\cdot$ 30 s $\cdot$ fim previsto \textbf{42:20}}\par\vspace{1mm}
...
\begin{tcolorbox}[breakable,colback=white,colframe=teal!55,boxrule=0.6pt,arc=2pt,left=3mm,right=3mm,top=2mm,bottom=2mm]
{\small\color{soft}\textbf{S50} $\cdot$ slide \textbf{48} $\cdot$ PDF p.56 $\cdot$ 55 s $\cdot$ fim previsto \textbf{43:15}}\par\vspace{1mm}
...
\end{tcolorbox}\vspace{2mm}
\begin{tcolorbox}[breakable,colback=white,colframe=teal!55,boxrule=0.6pt,arc=2pt,left=3mm,right=3mm,top=2mm,bottom=2mm]
{\small\color{soft}\textbf{S51} $\cdot$ slide \textbf{49} $\cdot$ PDF p.57 $\cdot$ 45 s $\cdot$ fim previsto \textbf{44:00}}\par\vspace{1mm}
{\large\bfseries\color{ink} The contribution, in one block}\par\vspace{2mm}
...
\end{tcolorbox}\vspace{2mm}
\begin{tcolorbox}[breakable,colback=white,colframe=teal!55,boxrule=0.6pt,arc=2pt,left=3mm,right=3mm,top=2mm,bottom=2mm]
{\small\color{soft}\textbf{S52} $\cdot$ slide \textbf{50} $\cdot$ PDF p.58 $\cdot$ 65 s $\cdot$ fim previsto \textbf{45:05}}\par\vspace{1mm}
...
\end{tcolorbox}\vspace{2mm}
\begin{tcolorbox}[breakable,colback=white,colframe=teal!55,boxrule=0.6pt,arc=2pt,left=3mm,right=3mm,top=2mm,bottom=2mm]
{\small\color{soft}\textbf{S53} $\cdot$ slide \textbf{51} $\cdot$ PDF p.59 $\cdot$ 65 s $\cdot$ fim previsto \textbf{46:10}}\par\vspace{1mm}
...
\end{tcolorbox}\vspace{2mm}
\begin{tcolorbox}[breakable,colback=white,colframe=teal!55,boxrule=0.6pt,arc=2pt,left=3mm,right=3mm,top=2mm,bottom=2mm]
{\small\color{soft}\textbf{S54} $\cdot$ slide \textbf{52} $\cdot$ PDF p.60 $\cdot$ 70 s $\cdot$ fim previsto \textbf{47:20}}\par\vspace{1mm}
...
\end{tcolorbox}\vspace{2mm}
\begin{tcolorbox}[breakable,colback=white,colframe=teal!55,boxrule=0.6pt,arc=2pt,left=3mm,right=3mm,top=2mm,bottom=2mm]
{\small\color{soft}\textbf{S55} $\cdot$ slide \textbf{53} $\cdot$ PDF p.61 $\cdot$ 30 s $\cdot$ fim previsto \textbf{47:50}}\par\vspace{1mm}
