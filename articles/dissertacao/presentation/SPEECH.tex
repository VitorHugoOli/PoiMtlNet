...
\end{tcolorbox}\vspace{2mm}
\begin{tcolorbox}[breakable,colback=white,colframe=teal!55,boxrule=0.6pt,arc=2pt,left=3mm,right=3mm,top=2mm,bottom=2mm]
{\small\color{soft}\textbf{S9} $\cdot$ slide \textbf{9} $\cdot$ PDF p.12 $\cdot$ 40 s $\cdot$ fim previsto \textbf{6:45}}\par\vspace{1mm}
...
\end{tcolorbox}\vspace{2mm}
\begin{tcolorbox}[breakable,colback=white,colframe=teal!55,boxrule=0.6pt,arc=2pt,left=3mm,right=3mm,top=2mm,bottom=2mm]
{\small\color{soft}\textbf{S8} $\cdot$ slide \textbf{10} $\cdot$ PDF p.13 $\cdot$ 75 s $\cdot$ fim previsto \textbf{8:00}}\par\vspace{1mm}
