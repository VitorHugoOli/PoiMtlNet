...
{\color{teal}\textbf{\textrightarrow}}\ \textbf{\itshape Segundo resultado. Em cima, a próxima categoria; embaixo, a próxima região; os mesmos seis conjuntos, na mesma ordem, nos dois blocos.}\par\vspace{1.5mm}
{\small\color{teal}\textbf{DIZER EXATO}}
\begin{itemize}[leftmargin=6mm,itemsep=0.4mm,topsep=0.8mm]
\item entre sementes
\end{itemize}
