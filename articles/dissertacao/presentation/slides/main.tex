...
\begin{frame}{One lineage, one idea}
    ...
    \begin{columns}[t,onlytextwidth]
        \begin{column}{0.604\textwidth}
            \scriptsize
            \renewcommand{\arraystretch}{1.1}\begin{tabular}{@{}lp{6.2cm}@{}}
                \toprule
...
\begin{frame}{The evidence base: six datasets, said once}
    \centering
    \footnotesize
    \renewcommand{\arraystretch}{1.1}\begin{tabular}{@{}llrrrl@{}}
        \toprule
...
\begin{frame}{The ladder: three studies, three layers}
    ...
    \renewcommand{\arraystretch}{1.05}\begin{tabular}{@{}p{0.115\textwidth} p{0.195\textwidth} p{0.205\textwidth} p{0.215\textwidth} p{0.195\textwidth}@{}}
        \toprule
...
\begin{frame}{Six limitations, six next steps (1 of 2)}
    ...
    {\scriptsize
    \setlength{\tabcolsep}{4pt}
    \renewcommand{\arraystretch}{1.15}\begin{tabular}{@{}p{6.6cm} p{7.0cm}@{}}
        \toprule
