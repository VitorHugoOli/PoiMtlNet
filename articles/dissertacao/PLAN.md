...
- Skeleton + **both build modes** from a single `main.tex` (defense **105 pp** → `src/dissertacao.pdf`;
  final AcademicoPG **102 pp** → `build/main_final.pdf`); 0 errors, 0 undefined refs/cites, 0 overfull
