...
% The page counts do NOT return to the 106/101 that HEAD produces. The conversion is not what moved
% them, and that was isolated rather than assumed: in a scratch copy, this round's eight rows put back
% into the original float container build to the same 109/105, with the "Float too large" warning
% present in both variants. So the conversion costs zero pages and removes the warning; the growth
% belongs to the round's prose additions in Chapters 3, 4 and 5 and in this appendix (defense 106 -> 109,
% final 101 -> 105, measured by reverting only this round's files in a second scratch copy).
