...
to balance. That is why varying the gradient balancer changed so little in the first study, and why
...
over the same five folds. Each of those six is measured at a single random initialization; the
variation the tests see is across folds, not across restarts of the same fold. Because those twelve reuse one set of folds they are not independent of one
