...
% PENDENCIAS 5.3, quoted: "vamos refaze-la para ser mais entendivel e facil de ser lida", with
...
% THE INTERPRETATION IS THE ONE RECORDED IN PENDENCIAS 5.3, which reads the intended meaning as "a
