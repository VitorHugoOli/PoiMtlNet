...
for the sparser United States state datasets used here, a change under which the category
F1 on Alabama, over five folds, rose monotonically from 0.74 to 0.82 across the swept
values.
