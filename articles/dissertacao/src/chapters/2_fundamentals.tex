...
Chapter~\ref{ch:cbic} reports five-fold cross-validation without identifying the split
axis, Chapter~\ref{ch:courb} states that its split is stratified by sample rather than by
user, so that the check-ins of one user may appear in both training and validation, and
only Chapter~\ref{ch:mobiwac} splits by user. The statistical treatment is scoped the
