...
% 59 .tex files under src/ (build/ excluded, it holds generated copies), all 17 files under
% src/tables/, and the 16 files of the submitted manuscript at articles/[mobiwac]/src/. Neither term
