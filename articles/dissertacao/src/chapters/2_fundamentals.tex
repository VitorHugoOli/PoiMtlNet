...
%           if any(h.values()): print(f,h)
%   PY
%   # EXPECT before this edit: ONE line, src/chapters/2_fundamentals.tex {'MRR': 1, 'Delta_m': 1}.
%   # EXPECT after it: no output at all.
...
% already inside the 54. Re-measured by the command above, whose file list is now printed rather
% than described: 54 + 16 = 70 swept, 0 hits after the edit, and it reproduces the ONE-hit-per-term
% result before it.
