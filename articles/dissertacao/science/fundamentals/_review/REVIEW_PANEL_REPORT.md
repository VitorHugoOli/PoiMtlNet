...
| B3 | 2.3 / bib | BLOCKER | `misra2016cross` DOI `.434` resolves to the wrong paper; correct Cross-Stitch DOI is `.433`. | **Author** — author-owned CBIC bib; already recorded in `../../../../CBIC___MTL/ERRATA.md` item 4 (verified). Sentence itself is accurate. |
