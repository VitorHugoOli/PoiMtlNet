...
repository state, and Chapter 3's own run records are lost (`dissertation_review_v2.md` REV-012),
...
is partly "the records are lost" (`dissertation_review_v2.md` REV-012 records exactly that). The
