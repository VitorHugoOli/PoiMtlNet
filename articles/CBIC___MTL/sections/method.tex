...
% [2026-07-30, dissertation PENDENCIAS 2.15, author decision: path A] CITATION SUBSTITUTED in this
% published source, ruder2017sluice -> baxter2000model, on the author's instruction to correct the
% original articles and record each in the dissertation's errata appendix. The published PDF of
% record at CBIC 2025 (DOI 10.21528/CBIC2025-1191324) is NOT edited and still carries the old key;
% this is the working source.
% Ruder et al. is a soft-sharing method presented as an improvement on fixed sharing, so it does not
% support a bullet arguing that hard sharing regularizes. Baxter 2000 (JAIR 12:149-198,
% DOI 10.1613/jair.731, verified at Crossref 2026-07-30) states the hypothesis-space-constraint
% argument the bullet makes. baxter2000model is already in this file's bibliography at
% references.bib:130 and no entry is added. ruder2017sluice stays cited at sections/basis.tex:48 and
% :56, where it is correct.
