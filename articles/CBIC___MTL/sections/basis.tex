...
% [2026-07-30, dissertation PENDENCIAS 2.12, author decision] CLAIM NARROWED in this published source,
% on his instruction to record the point in the dissertation's Appendix B ("pode adicionar essa linha no
% appendix B, para termos conhecimento desse detalhe menor e nao deixar passar batido"). The published
% PDF of record (CBIC 2025, DOI 10.21528/CBIC2025-1191324) is NOT edited and still reads
% "Pareto-optimal descent directions"; this is the working source.
% sener2018mgda states a dichotomy, not per-step Pareto optimality: the direction decreases all
% objectives, or the point is already Pareto-stationary. The Pareto optimality it proves is for an upper
% bound on the multi-objective loss, under stated assumptions (abstract, arXiv:1810.04650, read
% 2026-07-30). This work does not use MGDA, so no result depends on the sentence.
