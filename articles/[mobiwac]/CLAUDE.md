...
metric `top10_acc_indist*(1-ood_frac)`, from `reg_per_fold`). The cell is the **per-task diagnostic-best** fold-mean
...
is accepted as corroboration** (CA's main cell is bf16, corroborated to 0.03 pp). (4) For a stats claim, re-run the
