% !TeX root = ../main.tex
% sections/03_problem.tex -- Section III of the MobiWac 2026 camera-ready (accepted 2026-08-26).
% Identical in prose to the accepted text and to the dissertation's Chapter 5 (only label names
% differ); CONSOLIDATION_PLAN 3.17: no port, no edit.
