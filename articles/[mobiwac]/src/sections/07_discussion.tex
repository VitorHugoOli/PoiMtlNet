...
of the time. On the four datasets we measured (Alabama, Arizona, Florida, and Istanbul; a single seed over five folds), the ten shortlisted regions sit about 3 to 8 kilometers from the shortlist's
...
can consume; structural analysis of check-in networks has itself named machine
learning as a next step~\cite{moura2025mobilityaware}, and learning over
check-in structure moves in that direction.
