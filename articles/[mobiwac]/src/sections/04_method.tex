...
Fig.~\ref{fig:dataflow} shows the full data flow, from check-ins to the two outputs.
...
posterior that macro-F1 rewards. Inference uses the unadjusted logits.
