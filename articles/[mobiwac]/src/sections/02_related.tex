...
% same orphan. No claim changed.
% [2026-09-06, later] The comment above had swallowed the head of the next sentence into its last
% line (fourth instance of the mid-sentence-comment defect, mirror direction); repaired.
The same quantity, measured on the reported joint model at four of the six datasets
