...
\begin{itemize}
  ...
  \item An empirical account, across five U.S. states and one international city, of how the joint gain scales with the number of regions.
    ...
    regions, is also ahead on region. The California and Texas joint results
    use a single random initialization; the other four datasets use four for
    both models (Section~\ref{sec:results-part2}).
\end{itemize}
