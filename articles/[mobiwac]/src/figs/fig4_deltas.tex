...
check-in count (Table~\ref{tab:datasets}), with each dataset's region count under its label. The
category differences (macro-F1) are small in both directions; on the region axis
