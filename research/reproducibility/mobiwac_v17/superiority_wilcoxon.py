...
- Category (all 6 states): superiority, MTL champion-G cat > STL dedicated cat ceiling.
  PRE-REGISTERED, in docs/reproducibility/mobiwac_v17/STATISTICAL_PROTOCOL.md
...
- Region (FL/CA/TX): superiority, MTL reg > STL dedicated reg ceiling.
  ...
  record: the frozen protocol's deviation D-4 (2026-07-25), which notes that this
...
research/reproducibility/mobiwac_v17/m2_prereg_perfold.py (deviation D-3,
2026-07-25).
"""
import json
