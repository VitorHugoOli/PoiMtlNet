"""Archive a training run into docs/studies/results/<phase>/<test_id>/.
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Archive a training run into docs/studies/results/.")
