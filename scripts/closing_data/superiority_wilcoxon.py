...
- Category (all 6 states): superiority, MTL champion-G cat > STL dedicated cat ceiling.
  PRE-REGISTERED, in analysis_protocol/STATISTICAL_PROTOCOL.md
...
- Region (FL/CA/TX): superiority, MTL reg > STL dedicated reg ceiling.
  ...
  record: analysis_protocol/DEVIATION_LOG.md, entry D-4 (2026-07-25), which notes that this
...
scripts/closing_data/m2_prereg_perfold.py (DEVIATION_LOG.md D-3,
2026-07-25).
"""
import json
